"""
Django settings for Linkzur_backend project.
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:8081",  # or wherever your frontend runs
...
SIMPLE_JWT = {
    ...
    'REFRESH_TOKEN_LIFETIME': timedelta(days=7),  # optional, refresh token lifetime
